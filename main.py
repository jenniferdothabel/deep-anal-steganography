        ...
        if is_image:
            ...
            try:
                ...
                if detection_result is None:
                    st.warning("Detection returned None - using fallback")
                    likelihood = 0
                    ...
                    if likelihood == 0.0 and detection_result.explanation and detection_result.explanation.startswith("Error"):
                        st.error(f"Detection error: {detection_result.explanation}")
            except Exception as e:
                import traceback
